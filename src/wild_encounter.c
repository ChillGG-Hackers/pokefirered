...
const u8 gFlagSecName_PalletTown[] = _("PALLET TOWN");
const u8 gFlagSecName_ViridianCity[] = _("VIRIDIAN CITY");
const u8 gFlagSecName_PewterCity[] = _("PEWTER CITY");
const u8 gFlagSecName_CeruleanCity[] = _("CERULEAN CITY");
const u8 gFlagSecName_LavenderTown[] = _("LAVENDER TOWN");
const u8 gFlagSecName_VermilionCity[] = _("VERMILION CITY");
const u8 gFlagSecName_CeladonCity[] = _("CELADON CITY");
const u8 gFlagSecName_FuchsiaCity[] = _("FUCHSIA CITY");
...
const u8 gFlagSecName_UndergroundPath[] = _("UNDERGROUND PATH");
const u8 gFlagSecName_UndergroundPath_2[] = _("UNDERGROUND PATH");
const u8 gFlagSecName_DiglettsCave[] = _("DIGLETT'S CAVE");
const u8 gFlagSecName_VictoryRoad[] = _("VICTORY ROAD");
const u8 gFlagSecName_RocketHideout[] = _("ROCKET HIDEOUT");
const u8 gFlagSecName_SilphCo[] = _("SILPH CO.");
const u8 gFlagSecName_PokemonMansion[] = _("POKEMON MANSION");
const u8 gFlagSecName_SafariZone[] = _("SAFARI ZONE");
const u8 gFlagSecName_PokemonLeague[] = _("POKEMON LEAGUE");
const u8 gFlagSecName_RockTunnel[] = _("ROCK TUNNEL");
const u8 gFlagSecName_SeafoamIslands[] = _("SEAFOAM ISLANDS");
const u8 gFlagSecName_PokemonTower[] = _("POKEMON TOWER");
const u8 gFlagSecName_CeruleanCave[] = _("CERULEAN CAVE");
const u8 gFlagSecName_PowerPlant[] = _("POWER PLANT");
const u8 gFlagSecName_OneIsland[] = _("ONE ISLAND");
const u8 gFlagSecName_TwoIsland[] = _("TWO ISLAND");
const u8 gFlagSecName_ThreeIsland[] = _("THREE ISLAND");
const u8 gFlagSecName_FourIsland[] = _("FOUR ISLAND");
const u8 gFlagSecName_FiveIsland[] = _("FIVE ISLAND");
const u8 gFlagSecName_SevenIsland[] = _("SEVEN ISLAND");
const u8 gFlagSecName_SixIsland[] = _("SIX ISLAND");
const u8 gFlagSecName_KindleRoad[] = _("KINDLE ROAD");
const u8 gFlagSecName_TreasureBeach[] = _("TREASURE BEACH");
const u8 gFlagSecName_CapeBrink[] = _("CAPE BRINK");
const u8 gFlagSecName_BondBridge[] = _("BOND BRIDGE");
const u8 gFlagSecName_ThreeIslePort[] = _("THREE ISLE PORT");
const u8 gFlagSecName_SeviiIsle6[] = _("SEVII ISLE 6");
const u8 gFlagSecName_SeviiIsle7[] = _("SEVII ISLE 7");
const u8 gFlagSecName_SeviiIsle8[] = _("SEVII ISLE 8");
const u8 gFlagSecName_SeviiIsle9[] = _("SEVII ISLE 9");
const u8 gFlagSecName_ResortGorgeous[] = _("RESORT GORGEOUS");
const u8 gFlagSecName_WaterLabyrinth[] = _("WATER LABYRINTH");
const u8 gFlagSecName_FiveIsleMeadow[] = _("FIVE ISLE MEADOW");
const u8 gFlagSecName_MemorialPillar[] = _("MEMORIAL PILLAR");
const u8 gFlagSecName_OutcastIsland[] = _("OUTCAST ISLAND");
const u8 gFlagSecName_GreenPath[] = _("GREEN PATH");
const u8 gFlagSecName_WaterPath[] = _("WATER PATH");
const u8 gFlagSecName_RuinValley[] = _("RUIN VALLEY");
const u8 gFlagSecName_TrainerTower[] = _("TRAINER TOWER");
const u8 gFlagSecName_CanyonEntrance[] = _("CANYON ENTRANCE");
const u8 gFlagSecName_SevaultCanyon[] = _("SEVAULT CANYON");
const u8 gFlagSecName_TanobyRuins[] = _("TANOBY RUINS");
const u8 gFlagSecName_SeviiIsle22[] = _("SEVII ISLE 22");
const u8 gFlagSecName_SeviiIsle23[] = _("SEVII ISLE 23");
const u8 gFlagSecName_SeviiIsle24[] = _("SEVII ISLE 24");
const u8 gFlagSecName_NavelRock[] = _("NAVEL ROCK");
const u8 gFlagSecName_MtEmber[] = _("MT. EMBER");
const u8 gFlagSecName_BerryForest[] = _("BERRY FOREST");
const u8 gFlagSecName_IcefallCave[] = _("ICEFALL CAVE");
const u8 gFlagSecName_RocketWarehouse[] = _("ROCKET WAREHOUSE");
const u8 gFlagSecName_TrainerTower_2[] = _("TRAINER TOWER");
const u8 gFlagSecName_DottedHole[] = _("DOTTED HOLE");
const u8 gFlagSecName_LostCave[] = _("LOST CAVE");
const u8 gFlagSecName_PatternBush[] = _("PATTERN BUSH");
const u8 gFlagSecName_AlteringCave[] = _("ALTERING CAVE");
const u8 gFlagSecName_TanobyChambers[] = _("TANOBY CHAMBERS");
const u8 gFlagSecName_ThreeIslePath[] = _("THREE ISLE PATH");
const u8 gFlagSecName_TanobyKey[] = _("TANOBY KEY");
const u8 gFlagSecName_BirthIsland[] = _("BIRTH ISLAND");
const u8 gFlagSecName_MoneanChamber[] = _("MONEAN CHAMBER");
const u8 gFlagSecName_LiptooChamber[] = _("LIPTOO CHAMBER");
const u8 gFlagSecName_WeepthChamber[] = _("WEEPTH CHAMBER");
const u8 gFlagSecName_DilfordChamber[] = _("DILFORD CHAMBER");
const u8 gFlagSecName_ScufibChamber[] = _("SCUFIB CHAMBER");
const u8 gFlagSecName_RixyChamber[] = _("RIXY CHAMBER");
const u8 gFlagSecName_ViapoisChamber[] = _("VIAPOIS CHAMBER");
const u8 gFlagSecName_EmberSpa[] = _("EMBER SPA");
const u8 gFlagSecName_CeladonDept[] = _("CELADON DEPT.");
...
bool8 GetMapFlag(u8 mapName[]) {
	...
	u8 plswork[25] = _("Get prob");
	u8 WHYYYY[25] = _("STOP IT NOW");
	bool8 result;
	//char* test = (char*)*mapName;
	//char* mapName = mapNameU8;
	SetMonData(&gPlayerParty[0], MON_DATA_NICKNAME, mapName);
	//strlen(mapName) != strlen(gFlagSecName_Route22)
	if (strcmp(mapName, "ROUTE 22") == 0)
		SetMonData(&gPlayerParty[0], MON_DATA_NICKNAME, work);
	if (strcmp(mapName, gFlagSecName_PalletTown) == 0) {
		//SetMonData(&gPlayerParty[1], MON_DATA_NICKNAME, prob);
